...
<form name="writeFrm" method="post" enctype="multipart/form-data"
    action="../Project02/adminWritePhoto.admin?flag=${param.flag } onsubmit="return formValidate(this);">
<table width="90%">
...
<input type="hid den" name="flag" value="${param.flag }" />
    ...
    <tr>
   	 <td colspan="2" align="right" >
   		 ...
   		 <button type="button" onclick="location.href='../Project02/photoAdmin.list';">
   			 리스트바로가기
   		 </button>
   	 </td>
    </tr>
