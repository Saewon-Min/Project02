...
<form action="../write.member" method="post" name="loginFrm" onsubmit="return loginValdidate(this);">
    ...
    <div class="wrap_regiform">
        ...
        <table class="regi_table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="user_id" value="minsw626" />  
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="pass1" value="ALStd1995@" />                   
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="pass2" value="ALStd1995@" />
                </td>
            </tr>
            <tr>
                <td><span class="red">*</span> 이름</td>
                <td>
                    <input type="text" class="w01" name="name" value="민세원" />
            ...
            <tr>
                ...
                <td style="padding: 0px 0 5px 5px;">
                    <input type="text" class="w02" name="birthday" id="birthday" value="21/09/01" />
            ...
            <tr>
                <td></td>
                <td>
                    <input type="text" class="w04" name="address1" value="서울시" />                
                    <input type="text" class="w04" name="address2" value="양천구" />
                </td>
            </tr>
            <tr>
                <td><span class="red">*</span> 이메일</td>
                <td>
                    <input type="text" class="w05" name="email1" value="123" />
                    @
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" class="w06" name="mobile2" maxlength="4" 
                        value="123" onkeyup="commonFocusMove(this, 4, 'mobile3');" />
                    -
                    <input type="text" class="w06" name="mobile3" maxlength="4" 
                        value="123" onkeyup="commonFocusMove(this, 4, 'tel1');" />
                </td>
            </tr>
            <tr>
                <td>전화번호</td>
        ...
        <div style="text-align: center; margin-top:10px;">
            ...
            <input type="button" value="메인으로" onclick="location.href='../main/main.jsp';" />
        </div>
    </div>
</div>
</form>
