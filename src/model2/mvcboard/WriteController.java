...
public class WriteController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(commandStr.equals("/spacesub01.write")) {
			req.getRequestDispatcher("/space/Write.jsp").forward(req, resp);
	...
	private void noticeWrite(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(mr!= null) {
			...
			if(result==1) {
				...
				resp.sendRedirect("../spacesub01.write");
			}
			
		}else {
			// 파일 첨부를 위한 객체 생성이 안된 경우
			JSFunction.alertLocation(resp, "글 작성 중 오류가 발생했습니다.","../spacesub01.write");
		}
